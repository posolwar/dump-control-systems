...
<template>
  <PageLayout>
    <ContainerElement pagination :total-items="pagination.totalItems" :items-per-page="pagination.itemsPerPage">
      <div class="container">
        <AppElement :content="logs" title="Последние логи действий" type="big" />
      </div>
    </ContainerElement>
  </PageLayout>
</template>
